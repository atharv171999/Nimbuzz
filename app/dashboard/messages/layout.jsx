...
export default async function MessagesLayout({ children }) {
    ...
    return (
        <div className="absolute inset-0 flex bg-slate-50 overscroll-none z-10">
            ...
            <div className="w-[80px] sm:w-[340px] shrink-0 border-r border-slate-200 bg-white flex flex-col h-full overflow-hidden">
                        ...
                        contacts.map(contact => {
                            ...
                            return (
                                <Link
                                    ...
                                    className="flex items-center gap-3 p-3 sm:px-5 sm:py-4 hover:bg-slate-50 transition-colors border-b border-slate-100"
                                >
                                    <div className="w-10 h-10 sm:w-14 sm:h-14 shrink-0 rounded-full overflow-hidden border border-slate-200 bg-slate-50 mx-auto sm:mx-0">
