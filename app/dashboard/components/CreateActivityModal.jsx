...
export default function CreateActivityModal({ isOpen, onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
            <div className="w-full max-w-lg bg-white rounded-[2.5rem] overflow-hidden shadow-[0_20px_60px_-15px_rgba(147,51,234,0.15)] flex flex-col max-h-[90vh] border border-zinc-200 transition-all duration-300">
                <div className="p-7 border-b border-zinc-100 flex items-center justify-between">
                    <h2 className="text-2xl font-[family-name:var(--font-outfit)] font-black text-zinc-900 tracking-tight">Create a Community Ping</h2>
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <input 
                                ...
                                className="w-full bg-zinc-100 border-none rounded-2xl p-4 text-sm font-medium focus:ring-2 focus:ring-primary focus:bg-white transition-all"
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <select 
                                    name="category"
                                    className="w-full bg-zinc-100 border-none rounded-2xl p-4 text-sm focus:ring-2 focus:ring-primary focus:bg-white transition-all font-bold appearance-none text-zinc-600"
                                >
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    defaultValue="4"
                                    min="2"
                                    className="w-full bg-zinc-100 border-none rounded-2xl p-4 text-sm font-bold focus:ring-2 focus:ring-primary focus:bg-white transition-all"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                className="w-full bg-zinc-100 border-none rounded-3xl p-4 text-sm font-medium focus:ring-2 focus:ring-primary focus:bg-white transition-all resize-none"
                            ></textarea>
                        </div>
                    </div>
